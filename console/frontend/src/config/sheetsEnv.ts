...
export function getSheetsPollConfig() {
  const finalFromEnv = import.meta.env.VITE_FINAL_AUDIENCE_RANGE?.trim();
  return {
    sheetId: import.meta.env.VITE_GOOGLE_SHEET_ID ?? "",
    apiKey: import.meta.env.VITE_GOOGLE_SHEETS_API_KEY ?? "",
    round1AudienceRange: DEFAULT_ROUND1_AUDIENCE_RANGE,
    round2AudienceRange: DEFAULT_ROUND2_AUDIENCE_RANGE,
    round3AudienceRange: DEFAULT_ROUND3_AUDIENCE_RANGE,
    finalAudienceRange: finalFromEnv || DEFAULT_FINAL_AUDIENCE_RANGE,
